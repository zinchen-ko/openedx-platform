...
def check_course_access_with_redirect(course, user, action, check_if_enrolled=False, check_survey_complete=True, check_if_authenticated=False):  # lint-amnesty, pylint: disable=line-too-long
    ...
    log.debug("check_course_access_with_redirect: 1")
    ...
    log.debug("check_course_access_with_redirect: 2")
    log.debug(f"check_course_access_with_redirect: {str(access_response)}")

    if not access_response:
        # Redirect if StartDateError
        log.debug("check_course_access_with_redirect: 3")
        ...
        log.debug("check_course_access_with_redirect: 4")
        ...
        log.debug("check_course_access_with_redirect: 5")
        ...
        log.debug("check_course_access_with_redirect: 6")
        # Redirect if the user must answer a survey before entering the course.
        ...
        log.debug("check_course_access_with_redirect: 7")
        ...
        log.debug("check_course_access_with_redirect: 8")
        ...
        log.debug("check_course_access_with_redirect: 9")
        # Redirect if the user must answer a survey before entering the course.
        ...
        log.debug("check_course_access_with_redirect: 10")
